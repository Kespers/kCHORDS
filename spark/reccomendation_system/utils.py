...
def get_youtube_link_from_spotify_id(spotify_id):
    ...
    try:
        # Step 1: Ottieni i dettagli della traccia da Spotify
        ...
        # Step 2: Cerca il video su YouTube
...
def get_spotify_token():
  ...
  # Fai la richiesta POST per ottenere il token
